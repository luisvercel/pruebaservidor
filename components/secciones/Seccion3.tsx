...
import { Optimus } from "@/components/icons/icons_trading/optimus";
import { Magnus } from "@/components/icons/icons_trading/magnus";
import { Summus } from "@/components/icons/icons_trading/summus";


// ----------------------------------------------------------------------
// CONFIGURACIÓN DE LAS TARJETAS
// Cada tarjeta usa su propio icono como componente React.
// Puedes reemplazar Magnus por el componente que quieras.
// ----------------------------------------------------------------------
...
const cards = [
  ...
  },
  {
    ...
    description: "Estrategia que diversifica la inversión hasta en 10 instrumentos CFD de las categorías Forex e Índices.",
    iconComponent: Magnus,
  ...
  },
  {
    ...
    description: "Estrategia que diversifica hasta 20 instrumentos CFD: Forex, Índices, Metales y Crypto.",
    iconComponent: Summus,
...
export default function CarouselBots() {
  ...
  return (
    <div className="w-full flex flex-col items-center mt-20 select-none ">
      <p className="text-white text-center font-montserrat_bold text-3xl mb-3 pt-32 px-10">
        NUESTRAS ESTRATEGIAS DE INVERSIÓN
      </p>

      <p className="text-center text-zinc-400 text-[15px] mb-14 px-10">
      ...
      >
        ...
        {/* GRADIENT IZQUIERDA */}
        <div className="absolute left-0 top-0 h-full w-52 pointer-events-none bg-gradient-to-r from-black via-black/70 to-transparent z-[30]" />

        {/* GRADIENT DERECHA */}
        <div className="absolute right-0 top-0 h-full w-52 pointer-events-none bg-gradient-to-l from-black via-black/70 to-transparent z-[30]" />
        ...
        >
          ...
          {loopedCards.map((card, i) => {
            ...
            return (
              <div
                key={i}
                className="mt-6 relative rounded-3xl flex-shrink-0 flex flex-col items-center text-center transition-all duration-500"
              ...
              >
                ...
                >
                  ...
                  {/* ÍCONO */}
                  <div className={`mb-4 flex items-center justify-center ${card.iconSize}`}>
                    {/* <IconComponent color={isActive ? "black" : "white"} /> */}
      ...
      {/* BOTONES */}
      <div className="flex items-center gap-6 mt-14 pb-32">
        <button
          onClick={prev}
