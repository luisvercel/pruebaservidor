...
import { formatearFechaDia, normalizeText } from "../Utilidades";
...
export default function TablaProximos() {
    ...
    return (
        <div className={data.length < 3 ? "h-[200px]" : "" }>
...

                    {
                        ...
                        data.map((partido) => (
                                ...
                                <TableCell className={indexdata % 2 === 1 ? "bg-white/10 border-0 w-1/6 min-w-[80px]" : "border-0"}>
                                    <div className="flex items-center justify-center">
                                        <div className="bg-white/10 bg-opacity-20 border-0 rounded-xl sm:p-3 text-[#EABB54]">
                                            <p className="font-montserrat_medium text-center text-[10px] sm:text-[11px]">vs</p>
                                        </div>
                                    </div>
                                </TableCell>
                            ...
                            <div className="border-0 rounded-lg bg-[#cccccc] bg-opacity-[10%] w-full text-center">
                                <p className="font-montserrat_medium text-center text-[8px]">Terminado</p>
                            </div>
                        </TableCell> */}

                                <TableCell className={indexdata % 2 === 1 ? "bg-white/10 border-0 w-1/6 min-w-[120px]" : "border-0"}>
                                    <div className="text-center">
                                        <p className="font-montserrat_medium text-center text-[8px]">{formatearFechaDia(partido.FECHA)}</p>
                                    </div>
                                </TableCell>
            ...
            : <div className="h-[220px] bg-transparent text-white text-center"> </div>}
        </div>
    );
}