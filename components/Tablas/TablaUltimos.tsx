...
export default function TablaUltimos() {
                                ...
                                <TableCell className={indexdata % 2 === 1 ? "bg-white/10 border-0 w-1/6 min-w-[80px]" : "border-0"}>
                                    <div className="flex items-center justify-center">
                                        <div className="bg-white/10 bg-opacity-20 border-0 rounded-xl sm:p-3 text-[#EABB54]">
                                            <p className="font-montserrat_medium text-center text-[10px] sm:text-[11px]">{partido.RESULTADOLOCAL} - {partido.RESULTADOVISITANTE}</p>
                                        </div>
                                    </div>
                                </TableCell>
